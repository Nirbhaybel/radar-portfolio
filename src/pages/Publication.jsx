...
const publications = [
  {
    ...
    abstract:
      "The extraction of Micro-Doppler (M-D) signatures from radar signals is critical for classifying various targets. This study uses Machine Learning techniques to investigate the impact of phase noise on micro-Doppler extraction.",

    pdf: `${import.meta.env.BASE_URL}papers/Phase_noise.pdf`,
...

  {
    ...
    abstract:
      "In the modern age, highly sensitive advanced radar systems require very stable and accurate radar waveforms for micro-Doppler signature analysis and smaller Radar Cross section (RCS) detection.",

    pdf: `${import.meta.env.BASE_URL}papers/Ultra_Low_Phase_Noise.pdf`,
...

  {
    ...
    authors: "Nirbhay Kumar Singh",

    abstract:
      "Achieving synchronization in multi-channel transmit and receive systems has traditionally involved complex length-matched channel designs.",

    pdf: `${import.meta.env.BASE_URL}papers/Multi_board.pdf`,
...

  {
    ...
    abstract:
      "Power amplifiers (PAs) are crucial in RF RADAR and communication systems, but their nonlinearities often degrade signal quality.",

    pdf: `${import.meta.env.BASE_URL}papers/1571249925_final.pdf`,
...

  {
    ...
    abstract:
      "Modern high-power systems like Radars and communication need very accurate and temperature invariant systems to measure the transmitted power and VSWR.",

    pdf: `${import.meta.env.BASE_URL}papers/A_Wide_band.pdf`,
...

  {
    ...
    abstract:
      "This paper relates to the realization of 3U-VPX based programmable Digital Transceiver to support different modes of Identification of Friend and Foe (IFF) systems.",

    pdf: `${import.meta.env.BASE_URL}papers/A_ProgrammableMultimode.pdf`,
...

  {
    ...
    abstract:
      "Power amplifier, a critical component of the RF chain, is the main source that is responsible for signal distortion.",

    pdf: `${import.meta.env.BASE_URL}papers/A_Method_to_Enhance_Power_Amplifier_Linearity_Using_Time_Delay_Estimation_amp_Correction_Technique.pdf`,
